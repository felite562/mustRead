...
public class ListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("Must Read Books");
...
cursor.close();
    ...
    FloatingActionButton fab = findViewById(R.id.addBtn);
        ...
        public void onClick(View view) {
            ...
            //   finish();
            final CharSequence[] items1 = {"Add", "Search in library"};

            AlertDialog.Builder dialog1 = new AlertDialog.Builder(ListActivity.this);

            dialog1.setTitle("Choose an action");
            dialog1.setItems(items1, new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialogInterface, int i) {
                    if (i == 0){
                        startActivity(new Intent(ListActivity.this, MainActivity.class));
                    ...
                    if (i==1){
                        startActivity(new Intent(ListActivity.this, KeyActivity.class));
                        finish();
                    }
    ...
    startActivity(new Intent(ListActivity.this, UpdateActivity.class));
    finish();}
    private void showDialogUpdate(Activity activity, final int position){
        ...
        imageViewIcon = dialog.findViewById(R.id.iViewBook);
        final EditText edtName = dialog.findViewById(R.id.tViewName);
        final EditText edtAuthor = dialog.findViewById(R.id.tViewAuthor);
